...
# Fine-tuning 
XL:
CUDA_VISIBLE_DEVICES=0 nnUNetv2_train 603 3d_fullres all -device cuda --npz -tr nnUNetTrainerDiceTopK10FocalFineTuning -p nnUNetResEncUNetXLPlans -pretrained_weights /media/volume1/khoa/BRATS25/7/Experiments/v03_nnunet211/nnUNetv2/nnUNet_results/Dataset601_BraTS/nnUNetTrainer__nnUNetResEncUNetXLPlans__3d_fullres/fold_all/checkpoint_best.pth

L:
CUDA_VISIBLE_DEVICES=2 nnUNetv2_train 603 3d_fullres all -device cuda --npz -tr nnUNetTrainerDiceTopK10FocalFineTuning -p nnUNetResEncUNetLPlans -pretrained_weights /media/volume1/khoa/BRATS25/7/Experiments/v03_nnunet211/nnUNetv2/nnUNet_results/Dataset601_BraTS/nnUNetTrainer__nnUNetResEncUNetLPlans__3d_fullres/fold_all/checkpoint_best.pth

M:
CUDA_VISIBLE_DEVICES=1 nnUNetv2_train 603 3d_fullres all -device cuda --npz -tr nnUNetTrainerDiceTopK10FocalFineTuning -p nnUNetResEncUNetMPlans -pretrained_weights /media/volume1/khoa/BRATS25/7/Experiments/v03_nnunet211/nnUNetv2/nnUNet_results/Dataset601_BraTS/nnUNetTrainer__nnUNetResEncUNetMPlans__3d_fullres/fold_all/checkpoint_best.pth
"""
class nnUNetTrainerDiceTopK10FocalFineTuning(nnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.initial_lr = 2e-4 #1e-2 # for fine-tune
        self.weight_decay = 3e-5
        self.oversample_foreground_percent = 0.33
        self.num_iterations_per_epoch = 250 #250
        self.num_val_iterations_per_epoch = 50
        self.num_epochs = 300 #1000 # for fine-tune
